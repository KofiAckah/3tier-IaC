...
resource "aws_db_subnet_group" "main" {
  # FIX: Add prefix "db-" to ensure name starts with a letter
...
resource "aws_db_instance" "main" {
  # FIX: Add prefix "db-" to ensure identifier starts with a letter
  ...
  # FIX: Also add "db-" prefix to final snapshot identifier
